...
const Contact = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-violet-50 py-20">
        <div className="container mx-auto">
          <div className="-mx-1 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/10">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="text-center sm:text-[30px] text-dark mb-5 block text-base font-semibold">
                  Contact Us
                </span>
                  <p className="text-center mb-6 text-[20px]xl:text-[40px]">Get In Touch With Us 
                    Proin volutpat consequat porttitor cras nullam gravida at. Orci molestie a eu arcu.</p>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">
                      921 E.P Subhash Nagar Bareilly 243001. India
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full px-4  lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12 bg-violet-50">
                <form>
                  <div className="mb-6" >
                    <input
                      type="text"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="text-white bg-indigo-600 hover:bg-indigo-500 border-primary w-full rounded border p-3 focus:ring-4"
                    >
                      Send Message
                    </button>
                  </div>
